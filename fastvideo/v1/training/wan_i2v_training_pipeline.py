...
class WanI2VTrainingPipeline(TrainingPipeline):
    ...
    def _prepare_dit_inputs(self,
        ...
        # Don't concatenate image_latents here - we'll handle them separately after sharding
        # to ensure they're consistent across SP ranks
        
        return training_batch

    def train_one_step(self, training_batch: TrainingBatch) -> TrainingBatch:
        """Override to properly handle image latents with sequence parallelism"""
        assert self.training_args is not None
